...
REFERENCE_URL = (
    "https://raw.githubusercontent.com/XenoAmess/xenoamess_stellaries_dev/c057333/"
    "synthetic_queen_laoda_replacement/assets/reference/laoda-reference.jpg"
)
DEFAULT_PROMPT = Path(__file__).resolve().parents[1] / "assets/prompts/laoda-transparent-v1.txt"

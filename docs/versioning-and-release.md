...
- 待发布正式版本：`1.2.0`；简体中文实机验收已经通过，版本、changelog、工坊说明和上传包已冻结，下一步更新同一公开物品并完成远端核验。
...
- `1.1.0` 已保持计划 00—13 的玩法脚本不变，完成 10 种语言静态合同、S03/S04 计划 10 重复叠加闭环、I1-R01 蜂巢岗位闭环，并把完整说明与 Change Note 更新到同一公开版本。
